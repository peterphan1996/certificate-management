...
import { Tabs, Icon, Button, Tag, Upload, message, List } from "antd";
...
class Issue extends React.Component {
    ...
    for (let i = 0; i < fileList.length; i++) {
      try {
        ...
        this.setState(prevState => {
          prevState.hashedCertArray.push(fileContents);
        });
      } catch (e) {
        console.log(e);
        this.setState({
  ...
  createContractTrigger = async values => {
