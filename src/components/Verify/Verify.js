...
import { Icon, Button, Steps, notification, Tag, List, Popconfirm } from "antd";
...
const openNotificationWithIcon = (type, _message, description) => {
  notification[type]({
    message: _message,
    description,
      ...
      <div style={{ display: "grid" }}>
        ...
        >
          <Dropzone
            ...
            className="dropzone"
          >
            <Animated animationIn="wobble" animationOut="none" isVisible>
              <Icon
